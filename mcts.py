...
class MCTS:
    def __init__(self, root_state, agent_index, iterations=1000, max_depth=50, exploration_constant=1.41):
        ...
        :param agent_index: The index of the agent for which we are planning (our agent).
    ...
    def search(self):
        ...
        # Expand the root with one child per legal move
        self.root.children = []
    ...
    def is_terminal(self, state):
        ...
        This can be extended with additional conditions (e.g., move limits) as needed.
        """
