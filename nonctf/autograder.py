...
ERROR_HINT_MAP = {
  'q1': {
    "<type 'exceptions.IndexError'>": """
      ...
      assuming a certain number of successors from a gameState space
      or assuming a certain number of actions available from a given
      gameState. Try making your code more general (no hardcoded indices)
      and submit again!
    """
  },
  'q3': {
      "<type 'exceptions.AttributeError'>": """
        ...
        a certain size or structure to the gameState space. For example, if you have
        a line of code assuming that the gameState is (x, y) and we run your code
        on a gameState space with (x, y, z), this error could be thrown. Try
