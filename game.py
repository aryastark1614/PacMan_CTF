...
class Agent:
    ...
    def registerInitialState(self, gameState): # inspects the starting gameState
    """
...
class AgentState:
    """
    AgentStates hold the gameState of an agent (configuration, speed, scared, etc).
    """
...
class Game:
    ...
    def run( self ):
        ...
        ###self.display.initialize(self.gameState.makeObservation(1).data)
        ...
        while not self.gameOver:
            ...
            move_time = 0
            skip_action = False
            # Generate an observation of the gameState
            ...
            ###self.display.update( self.gameState.makeObservation(idx).data )
