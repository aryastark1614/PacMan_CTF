...
class CaptureAgent(Agent):
  ...
  def __init__( self, index, timeForComputing = .1 ):
    ...
    """
    # Agent index for querying gameState
    self.index = index
  ...
  def getAction(self, gameState):
    ...
    choose action method if you're in a gameState (rather than halfway through your last
  ...
  def getPreviousObservation(self):
    """
    Returns the GameState object corresponding to the last gameState this agent saw
    (the observed gameState of the game last time this agent moved - this may not include
  ...
  def getCurrentObservation(self):
    ...
    (the observed gameState of the game - this may not include
    all of your opponent's agent locations exactly).
    """
